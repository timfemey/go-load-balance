...
func TestStickyRoundRobinLoadBalancer(t *testing.T) {
	...
	lb := StickyROundRobinLoadBalancer([]string{
		mockServers[0].URL,
		mockServers[1].URL,
	})
	...
	fmt.Printf("Sticky Round Robin Load balancing: Average response time = %v\n", elapsed/100)
